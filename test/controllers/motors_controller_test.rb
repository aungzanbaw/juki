...
class MotorsControllerTest < ActionController::TestCase
  ...
  test "should create motor" do
    assert_difference('Motor.count') do
      post :create, motor: { brand: @motor.brand, name: @motor.name, price: @motor.price, qty: @motor.qty, watt: @motor.watt }
    end
  ...
  test "should update motor" do
    patch :update, id: @motor, motor: { brand: @motor.brand, name: @motor.name, price: @motor.price, qty: @motor.qty, watt: @motor.watt }
    assert_redirected_to motor_path(assigns(:motor))
  end
