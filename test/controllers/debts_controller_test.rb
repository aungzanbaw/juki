...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { amount: @debt.amount, date: @debt.date, msale_id: @debt.msale_id, paid: @debt.paid }
    end
  ...
  test "should update debt" do
    patch :update, id: @debt, debt: { amount: @debt.amount, date: @debt.date, msale_id: @debt.msale_id, paid: @debt.paid }
    assert_redirected_to debt_path(assigns(:debt))
  end
