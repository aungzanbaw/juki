...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { brand: @table.brand, height: @table.height, name: @table.name, price: @table.price, qty: @table.qty, width: @table.width }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { brand: @table.brand, height: @table.height, name: @table.name, price: @table.price, qty: @table.qty, width: @table.width }
    assert_redirected_to table_path(assigns(:table))
  end
